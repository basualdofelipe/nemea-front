...
interface AddSellingPriceInlineProps {
  productId: string;
  onClose: () => void;
}

export function AddSellingPriceInline({
  productId,
  onClose,
}: AddSellingPriceInlineProps): ReactElement {
  ...
  async function handleConfirm(): Promise<void> {
    ...
    setIsLoading(true);
    try {
      await apiClientFetch(`/api/products/${productId}/prices`, token, {
        method: 'POST',
